...
type BaseProps = InputHTMLAttributes<HTMLInputElement> & { as?: 'input' }
...
export const Input = forwardRef<HTMLInputElement | HTMLTextAreaElement, InputProps>(function Input(props, ref) {
  ...
  const { className, as: _as, ...rest } = props
  return <input ref={ref as ForwardedRef<HTMLInputElement>} className={cn(inputStyles, className)} {...rest} />
})
